...
<#
.SYNOPSIS
    Pester offline unit tests for List-HookSubscriptions.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'List-HookSubscriptions.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'List-HookSubscriptions.ps1' -Tag 'Offline', 'Hooks' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/_apis/hooks/subscriptions?api-version=7.2-preview.1" -and
                $Method -eq 'Get'
            }
        }
