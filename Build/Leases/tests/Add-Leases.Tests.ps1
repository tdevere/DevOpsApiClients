...
<#
.SYNOPSIS
    Pester offline unit tests for Add-Leases.ps1
...
Describe 'Add-Leases.ps1' -Tag 'Offline', 'Build' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'create_leases_200.json') -Raw | ConvertFrom-Json
        }
