...
BODY=$(cat <<EOF
{
  ...
  "maximumRetentionPolicy": "${MAXIMUM_RETENTION_POLICY}"
}
EOF
)
set -u
...
# API call
# ---------------------------------------------------------------------------
URL=$(ado_build_url "$ORG" "_apis/build/settings" "$API_VERSION" "$PROJECT")
...
# Version guard
# ---------------------------------------------------------------------------
ado_version_guard "$RESPONSE" "daysToKeepDeletedBuildsBeforeDestroy" "defaultRetentionPolicy"
