...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Generalsetting.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Generalsetting.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Get-Generalsetting.ps1' -Tag 'Offline', 'Build' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_general_settings_200.json') -Raw | ConvertFrom-Json
        }
