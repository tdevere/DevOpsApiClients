...
<#
.SYNOPSIS
    Pester offline unit tests for Update-Authorizedresource.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Update-Authorizedresource.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Update-Authorizedresource.ps1' -Tag 'Offline', 'Build' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'update_authorize_project_resources_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/build/authorizedresources?api-version=7.2" -and
                $Method -eq 'Patch'
            }
        }
