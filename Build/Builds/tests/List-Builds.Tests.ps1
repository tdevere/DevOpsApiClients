...
<#
.SYNOPSIS
    Pester offline unit tests for List-Builds.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'List-Builds.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'List-Builds.ps1' -Tag 'Offline', 'Build' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_builds_200.json') -Raw | ConvertFrom-Json
        }
