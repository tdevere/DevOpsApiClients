...
<#
.SYNOPSIS
    Pester offline unit tests for Invoke-Workitemsearchresults.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Invoke-Workitemsearchresults.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Invoke-Workitemsearchresults.ps1' -Tag 'Offline', 'Search' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'query_fetch_work_item_search_results_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://almsearch.dev.azure.com/testorg/$ProjectGuid/_apis/search/workitemsearchresults?api-version=7.2" -and
                $Method -eq 'Post'
            }
        }
