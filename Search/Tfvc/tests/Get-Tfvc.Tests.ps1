...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Tfvc.ps1
...
Describe 'Get-Tfvc.ps1' -Tag 'Offline', 'Search' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_tfvc_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://almsearch.dev.azure.com/testorg/$ProjectGuid/_apis/search/status/tfvc?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
