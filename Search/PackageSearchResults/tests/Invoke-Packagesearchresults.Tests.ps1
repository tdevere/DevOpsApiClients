...
<#
.SYNOPSIS
    Pester offline unit tests for Invoke-Packagesearchresults.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Invoke-Packagesearchresults.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Invoke-Packagesearchresults.ps1' -Tag 'Offline', 'Search' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'query_fetch_package_search_results_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://almsearch.dev.azure.com/testorg/_apis/search/packagesearchresults?api-version=7.2" -and
                $Method -eq 'Post'
            }
        }
