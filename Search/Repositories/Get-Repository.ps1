...
.DESCRIPTION
    Calls  GET {org}/_apis/search/status/repositories/{repository}?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/search/repositories/get?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/search/status/repositories/$Repository" -ApiVersion $ApiVersion -Project $ProjectId -BaseHost "almsearch.dev.azure.com"
