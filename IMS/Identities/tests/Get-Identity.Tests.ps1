...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Identity.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Identity.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Get-Identity.ps1' -Tag 'Offline', 'IMS' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_read_identities_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://vssps.dev.azure.com/testorg/_apis/identities?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
