...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Tags.ps1
...
Describe 'Get-Tags.ps1' -Tag 'Offline', 'WIT' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_tags_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/wit/tags?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
