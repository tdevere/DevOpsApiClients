...
.DESCRIPTION
    Calls  GET {org}/_apis/wit/tags/{tag_id_or_name}?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/wit/tags/get?view=azure-devops-rest-7.2
#>
