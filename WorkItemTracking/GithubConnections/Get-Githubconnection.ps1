...
.DESCRIPTION
    Calls  GET {org}/_apis/githubconnections?api-version=7.2
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/githubconnections" -ApiVersion $ApiVersion -Project $ProjectId
