...
Describe 'Remove-Recyclebin.ps1' -Tag 'Offline', 'WIT' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_deleted_work_item_shallow_references_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/wit/recyclebin?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
