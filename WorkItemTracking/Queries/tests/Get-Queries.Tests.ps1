...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Queries.ps1
    ...
    Context 'Successful API call (mocked)' {
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/wit/queries?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
