...
<#
.SYNOPSIS
    Pester offline unit tests for List-Fields.ps1
    ...
    Context 'Successful API call (mocked)' {
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/wit/fields?api-version=7.2-preview.3" -and
                $Method -eq 'Get'
            }
        }
