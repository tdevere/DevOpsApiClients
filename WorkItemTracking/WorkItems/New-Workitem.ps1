...
.DESCRIPTION
    Calls  POST {org}/_apis/wit/workitemsbatch?api-version=7.2
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/wit/workitemsbatch" -ApiVersion $ApiVersion -Project $ProjectId
