...
.DESCRIPTION
    Calls  GET {org}/_apis/wit/workitems?api-version=7.2
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/wit/workitems" -ApiVersion $ApiVersion -Project $ProjectId
