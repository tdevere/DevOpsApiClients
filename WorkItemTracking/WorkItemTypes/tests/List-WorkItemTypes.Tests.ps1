...
<#
.SYNOPSIS
    Pester offline unit tests for List-WorkItemTypes.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'List-WorkItemTypes.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'List-WorkItemTypes.ps1' -Tag 'Offline', 'WIT' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/wit/workitemtypes?api-version=7.2-preview.2" -and
                $Method -eq 'Get'
            }
        }
