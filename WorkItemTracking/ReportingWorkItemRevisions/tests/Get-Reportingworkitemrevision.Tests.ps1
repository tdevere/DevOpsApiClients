...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Reportingworkitemrevision.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Reportingworkitemrevision.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Get-Reportingworkitemrevision.ps1' -Tag 'Offline', 'WIT' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_read_reporting_revisions_get_200.json') -Raw | ConvertFrom-Json
        }
