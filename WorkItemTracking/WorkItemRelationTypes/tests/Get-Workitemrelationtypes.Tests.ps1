...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Workitemrelationtypes.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Workitemrelationtypes.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Get-Workitemrelationtypes.ps1' -Tag 'Offline', 'WIT' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_work_item_relation_types_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/_apis/wit/workitemrelationtypes?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
