...
.DESCRIPTION
    Calls  GET {org}/_apis/git/repositories/{repository_id}/refs?api-version=7.2-preview.2
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/git/repositories/$RepositoryId/refs" -ApiVersion $ApiVersion -Project $ProjectId
