...
.DESCRIPTION
    Calls  GET {org}/_apis/git/favorites/refs/{favorite_id}?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/git/refs-favorites/get?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/git/favorites/refs/$FavoriteId" -ApiVersion $ApiVersion -Project $ProjectId
...
#--- Output -----------------------------------------------------------------
Write-Host "Refs Favorites: $($response.name)"
