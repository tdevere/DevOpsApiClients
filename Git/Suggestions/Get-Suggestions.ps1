...
.DESCRIPTION
    Calls  GET {org}/_apis/git/repositories/{repository_id}/suggestions?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/git/suggestions/list?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/git/repositories/$RepositoryId/suggestions" -ApiVersion $ApiVersion -Project $ProjectId
