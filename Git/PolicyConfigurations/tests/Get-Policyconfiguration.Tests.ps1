...
Describe 'Get-Policyconfiguration.ps1' -Tag 'Offline', 'Git' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_policy_configurations_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/git/policy/configurations?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
