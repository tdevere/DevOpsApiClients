...
.DESCRIPTION
    Calls  GET {org}/_apis/git/policy/configurations?api-version=7.2
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/git/policy/configurations" -ApiVersion $ApiVersion -Project $ProjectId
