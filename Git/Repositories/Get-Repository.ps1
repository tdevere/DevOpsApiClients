...
.DESCRIPTION
    Calls  GET {org}/_apis/git/repositories/{repository_id}?api-version=7.2
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/git/repositories/$RepositoryId" -ApiVersion $ApiVersion -Project $ProjectId
