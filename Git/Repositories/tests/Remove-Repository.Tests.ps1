...
<#
.SYNOPSIS
    Pester offline unit tests for Remove-Repository.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Remove-Repository.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Remove-Repository.ps1' -Tag 'Offline', 'Git' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_deleted_repositories_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/git/deletedrepositories?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
