...
.DESCRIPTION
    Calls  PATCH {org}/_apis/git/recycleBin/repositories/{repository_id}?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/git/repositories/restore-repository-from-recycle-bin?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/git/recycleBin/repositories/$RepositoryId" -ApiVersion $ApiVersion -Project $ProjectId
