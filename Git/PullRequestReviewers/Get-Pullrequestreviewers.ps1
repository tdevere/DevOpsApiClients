...
.DESCRIPTION
    Calls  GET {org}/_apis/git/repositories/{repository_id}/pullRequests/{pull_request_id}/reviewers?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/git/pull-request-reviewers/list?view=azure-devops-rest-7.2
#>
