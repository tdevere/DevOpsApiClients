...
.DESCRIPTION
    Calls  GET {org}/_apis/git/repositories/{repository_id}/pullRequests/{pull_request_id}/workitems?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/git/pull-request-work-items/list?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/git/repositories/$RepositoryId/pullRequests/$PullRequestId/workitems" -ApiVersion $ApiVersion -Project $ProjectId
