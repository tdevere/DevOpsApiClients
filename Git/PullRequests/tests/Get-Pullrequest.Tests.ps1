...
Describe 'Get-Pullrequest.ps1' -Tag 'Offline', 'Git' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_pull_requests_by_project_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/git/pullrequests?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
