...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Accounts.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Accounts.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Get-Accounts.ps1' -Tag 'Offline', 'Account' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_accounts_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://app.vssps.visualstudio.com/testorg/_apis/accounts?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
