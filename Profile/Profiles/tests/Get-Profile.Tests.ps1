...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Profile.ps1
...
Describe 'Get-Profile.ps1' -Tag 'Offline', 'Profile' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_profiles_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://app.vssps.visualstudio.com/testorg/_apis/profile/profiles/testvalue?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
