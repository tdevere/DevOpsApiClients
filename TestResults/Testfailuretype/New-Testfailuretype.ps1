...
.DESCRIPTION
    Calls  POST {org}/_apis/testresults/testfailuretype?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/test-results/testfailuretype/create?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/testresults/testfailuretype" -ApiVersion $ApiVersion -Project $ProjectId -BaseHost "vstmr.dev.azure.com"
...
#--- Output -----------------------------------------------------------------
Write-Host "Testfailuretype: $($response.name)"
