...
.DESCRIPTION
    Calls  GET {org}/_apis/testresults/runs/{run_id}?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/test-results/runs/get?view=azure-devops-rest-7.2
#>
