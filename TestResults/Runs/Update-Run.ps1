...
.DESCRIPTION
    Calls  PATCH {org}/_apis/testresults/runs/{run_id}?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/test-results/runs/update?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/testresults/runs/$RunId" -ApiVersion $ApiVersion -Project $ProjectId -BaseHost "vstmr.dev.azure.com"
