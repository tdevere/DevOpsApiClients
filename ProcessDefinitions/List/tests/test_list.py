...
"""
Offline unit tests for list.py
...
SCRIPT = str(Path(__file__).resolve().parents[1] / "list.py")
...
class TestListURLAndAuth:
    ...
    def test_correct_url_and_auth_header(self):
        ...
        fixture = json.loads((FIXTURES / "list_200.json").read_text())
