...
SCRIPT = str(Path(__file__).resolve().parents[1] / "get.py")
...
class TestGetURLAndAuth:
    ...
    def test_correct_url_and_auth_header(self):
        ...
        fixture = json.loads((FIXTURES / "get_200.json").read_text())
