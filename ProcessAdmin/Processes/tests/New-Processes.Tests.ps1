...
Describe 'New-Processes.ps1' -Tag 'Offline', 'ProcessAdmin' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'create_import_process_template_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/_apis/work/processadmin/processes/import?api-version=7.2" -and
                $Method -eq 'Post'
            }
        }
