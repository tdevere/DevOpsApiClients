...
<#
.SYNOPSIS
    Pester offline unit tests for New-User.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'New-User.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'New-User.ps1' -Tag 'Offline', 'Graph' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'create_users_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://vssps.dev.azure.com/testorg/_apis/graph/users?api-version=7.2" -and
                $Method -eq 'Post'
            }
        }
