...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Users.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Users.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Get-Users.ps1' -Tag 'Offline', 'Graph' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_users_200.json') -Raw | ConvertFrom-Json
        }
