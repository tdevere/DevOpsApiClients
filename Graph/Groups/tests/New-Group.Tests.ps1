...
<#
.SYNOPSIS
    Pester offline unit tests for New-Group.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'New-Group.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'New-Group.ps1' -Tag 'Offline', 'Graph' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://vssps.dev.azure.com/testorg/_apis/graph/groups?api-version=7.2" -and
                $Method -eq 'Post'
            }
        }
