...
<#
.SYNOPSIS
    Pester offline unit tests for Invoke-Checkconfigurations.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Invoke-Checkconfigurations.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Invoke-Checkconfigurations.ps1' -Tag 'Offline', 'ApprovalsAndChecks' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'query_check_configurations_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/pipelines/checks/queryconfigurations?api-version=7.2" -and
                $Method -eq 'Post'
            }
        }
