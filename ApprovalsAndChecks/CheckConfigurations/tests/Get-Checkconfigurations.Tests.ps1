...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Checkconfigurations.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Checkconfigurations.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Get-Checkconfigurations.ps1' -Tag 'Offline', 'ApprovalsAndChecks' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_check_configurations_200.json') -Raw | ConvertFrom-Json
        }
