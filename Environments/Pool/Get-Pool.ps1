...
.DESCRIPTION
    Calls  GET {org}/_apis/pipelines/environments/{environment_id}/providers/virtualmachines/pool?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/environments/pool/get?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/pipelines/environments/$EnvironmentId/providers/virtualmachines/pool" -ApiVersion $ApiVersion -Project $ProjectId
