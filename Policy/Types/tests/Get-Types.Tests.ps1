...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Types.ps1
...
Describe 'Get-Types.ps1' -Tag 'Offline', 'Policy' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_types_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/policy/types?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
