...
<#
.SYNOPSIS
    Pester offline unit tests for List-PolicyConfigurations.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'List-PolicyConfigurations.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'List-PolicyConfigurations.ps1' -Tag 'Offline', 'Policy' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/policy/configurations?api-version=7.2-preview.1" -and
                $Method -eq 'Get'
            }
        }
