...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Teamprojectcollection.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Teamprojectcollection.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Get-Teamprojectcollection.ps1' -Tag 'Offline', 'ResourceUsage' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_team_project_collection_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/_apis/resourceusage?api-version=7.1" -and
                $Method -eq 'Get'
            }
        }
