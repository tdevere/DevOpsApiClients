...
<#
.SYNOPSIS
    Pester offline unit tests for Update-Orgenablement.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Update-Orgenablement.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Update-Orgenablement.ps1' -Tag 'Offline', 'AdvancedSecurity' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'update_org_enablement_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://advsec.dev.azure.com/testorg/_apis/management/enablement?api-version=7.2" -and
                $Method -eq 'Patch'
            }
        }
