...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Orgmeterusageestimate.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Orgmeterusageestimate.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Get-Orgmeterusageestimate.ps1' -Tag 'Offline', 'AdvancedSecurity' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_org_meter_usage_estimate_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://advsec.dev.azure.com/testorg/_apis/management/meterUsageEstimate/default?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
