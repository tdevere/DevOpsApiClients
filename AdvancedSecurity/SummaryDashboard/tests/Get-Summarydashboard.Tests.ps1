...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Summarydashboard.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Summarydashboard.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Get-Summarydashboard.ps1' -Tag 'Offline', 'AdvancedSecurity' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_summary_dashboard_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://advsec.dev.azure.com/testorg/_apis/reporting/summary/alertsbatch?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
