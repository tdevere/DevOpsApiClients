...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Projectenablement.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Projectenablement.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Get-Projectenablement.ps1' -Tag 'Offline', 'AdvancedSecurity' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_project_enablement_200.json') -Raw | ConvertFrom-Json
        }
