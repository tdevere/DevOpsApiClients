...
<#
.SYNOPSIS
    Pester offline unit tests for List-Teams.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'List-Teams.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'List-Teams.ps1' -Tag 'Offline', 'Core' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_teams_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/_apis/projects/testvalue/teams?api-version=7.2-preview.3" -and
                $Method -eq 'Get'
            }
        }
