...
<#
.SYNOPSIS
    Pester offline unit tests for Remove-Project.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Remove-Project.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Remove-Project.ps1' -Tag 'Offline', 'Core' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'delete_projects_200.json') -Raw | ConvertFrom-Json
        }
