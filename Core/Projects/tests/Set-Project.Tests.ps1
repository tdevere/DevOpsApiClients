...
<#
.SYNOPSIS
    Pester offline unit tests for Set-Project.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Set-Project.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Set-Project.ps1' -Tag 'Offline', 'Core' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'set_project_properties_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/_apis/projects/testvalue/properties?api-version=7.2" -and
                $Method -eq 'Patch'
            }
        }
