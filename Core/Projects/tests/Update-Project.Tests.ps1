...
Describe 'Update-Project.ps1' -Tag 'Offline', 'Core' {
    ...
    Context 'Input validation' {
        ...
        It 'Throws when ProjectId is empty' {
            {
                & $ScriptPath -Organization 'testorg' -Capabilities 'testvalue' -DefaultTeam 'testvalue' -ProjectId '' -Pat 'fakepat'
            } | Should -Throw '*is required*'
        }
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'update_projects_200.json') -Raw | ConvertFrom-Json
        }
