...
API:  GET {org}/_apis/projects?api-version=7.2
Auth: Basic (PAT)
...
logger = AdoLogger("list_projects", PAT)
logger.info("Get all projects in the organization that the authenticated user has access to.")
