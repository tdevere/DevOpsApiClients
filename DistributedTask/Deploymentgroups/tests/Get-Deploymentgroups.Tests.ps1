...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Deploymentgroups.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Deploymentgroups.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Get-Deploymentgroups.ps1' -Tag 'Offline', 'DistributedTask' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_deploymentgroups_200.json') -Raw | ConvertFrom-Json
        }
