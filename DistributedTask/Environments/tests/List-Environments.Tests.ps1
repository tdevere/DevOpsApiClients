...
<#
.SYNOPSIS
    Pester offline unit tests for List-Environments.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'List-Environments.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'List-Environments.ps1' -Tag 'Offline', 'DistributedTask' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_environments_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/distributedtask/environments?api-version=7.2-preview.1" -and
                $Method -eq 'Get'
            }
        }
