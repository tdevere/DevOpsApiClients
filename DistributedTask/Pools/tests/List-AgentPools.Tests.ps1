...
<#
.SYNOPSIS
    Pester offline unit tests for List-AgentPools.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'List-AgentPools.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'List-AgentPools.ps1' -Tag 'Offline', 'DistributedTask' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_pools_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/_apis/distributedtask/pools?api-version=7.2-preview.1" -and
                $Method -eq 'Get'
            }
        }
