...
.DESCRIPTION
    Calls  GET {org}/{team}/_apis/work/boards?api-version=7.2
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "$Team/_apis/work/boards" -ApiVersion $ApiVersion -Project $ProjectId
