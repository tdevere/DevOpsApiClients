...
.DESCRIPTION
    Calls  DELETE {org}/_apis/work/plans/{id}?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/work/plans/delete?view=azure-devops-rest-7.2
#>
