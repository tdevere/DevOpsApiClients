...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Plans.ps1
...
Describe 'Get-Plans.ps1' -Tag 'Offline', 'Work' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_plans_200.json') -Raw | ConvertFrom-Json
        }
