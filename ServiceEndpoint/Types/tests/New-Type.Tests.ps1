...
<#
.SYNOPSIS
    Pester offline unit tests for New-Type.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'New-Type.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'New-Type.ps1' -Tag 'Offline', 'ServiceEndpoint' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_filtered_service_endpoint_types_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/_apis/serviceendpoint/types?api-version=7.2" -and
                $Method -eq 'Post'
            }
        }
