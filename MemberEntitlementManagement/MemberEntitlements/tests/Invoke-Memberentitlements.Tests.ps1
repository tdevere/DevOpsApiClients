...
<#
.SYNOPSIS
    Pester offline unit tests for Invoke-Memberentitlements.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Invoke-Memberentitlements.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Invoke-Memberentitlements.ps1' -Tag 'Offline', 'MemberEntitlementManagement' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'query_member_entitlements_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://vsaex.dev.azure.com/testorg/_apis/memberentitlements?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
