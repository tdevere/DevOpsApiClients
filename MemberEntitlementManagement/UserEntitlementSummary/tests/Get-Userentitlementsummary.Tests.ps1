...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Userentitlementsummary.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Userentitlementsummary.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Get-Userentitlementsummary.ps1' -Tag 'Offline', 'MemberEntitlementManagement' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_user_entitlement_summary_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://vsaex.dev.azure.com/testorg/_apis/userentitlementsummary?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
