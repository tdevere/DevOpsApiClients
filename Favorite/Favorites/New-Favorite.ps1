...
.DESCRIPTION
    Calls  POST {org}/_apis/favorite/favorites?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/favorite/favorites/create-favorite?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/favorite/favorites" -ApiVersion $ApiVersion
