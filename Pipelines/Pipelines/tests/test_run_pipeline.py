...
"""
Offline unit tests for run_pipeline.py
...
SCRIPT = str(Path(__file__).resolve().parents[1] / "run_pipeline.py")
...
class TestRunPipelineEnvValidation:
...
class TestRunPipelineURLAndAuth:
    ...
    def test_correct_url_and_auth_header(self):
        ...
        expected_url = "https://dev.azure.com/testorg/a1b2c3d4-e5f6-7890-abcd-ef1234567890/_apis/pipelines/test-value-pipeline_id/runs?api-version=7.2-preview.1"

        fixture = json.loads((FIXTURES / "run_pipeline_200.json").read_text())
...
class TestRunPipelineHTTPErrors:
    ...
    def test_401_unauthorized(self):
        url = "https://dev.azure.com/testorg/a1b2c3d4-e5f6-7890-abcd-ef1234567890/_apis/pipelines/test-value-pipeline_id/runs?api-version=7.2-preview.1"
