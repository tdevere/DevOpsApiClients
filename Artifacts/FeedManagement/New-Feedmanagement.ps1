...
.DESCRIPTION
    Calls  POST {org}/_apis/packaging/Feeds/{feed_id}/views?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/artifacts/feed--management/create-feed-view?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/packaging/Feeds/$FeedId/views" -ApiVersion $ApiVersion -Project $ProjectId -BaseHost "feeds.dev.azure.com"
