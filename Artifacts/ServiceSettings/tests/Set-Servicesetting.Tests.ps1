...
<#
.SYNOPSIS
    Pester offline unit tests for Set-Servicesetting.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Set-Servicesetting.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Set-Servicesetting.ps1' -Tag 'Offline', 'Artifacts' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'set_globalpermissions_200.json') -Raw | ConvertFrom-Json
        }
