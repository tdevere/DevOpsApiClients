...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Servicesetting.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Servicesetting.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Get-Servicesetting.ps1' -Tag 'Offline', 'Artifacts' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_globalpermissions_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://feeds.dev.azure.com/testorg/_apis/packaging/globalpermissions?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
