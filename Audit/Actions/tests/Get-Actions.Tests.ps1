...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Actions.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Actions.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Get-Actions.ps1' -Tag 'Offline', 'Audit' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_actions_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://auditservice.dev.azure.com/testorg/_apis/audit/actions?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
