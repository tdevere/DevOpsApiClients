...
<#
.SYNOPSIS
    Pester offline unit tests for Invoke-Auditlog.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Invoke-Auditlog.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
}

Describe 'Invoke-Auditlog.ps1' -Tag 'Offline', 'Audit' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'query_audit_log_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://auditservice.dev.azure.com/testorg/_apis/audit/auditlog?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
