...
<#
.SYNOPSIS
    Pester offline unit tests for Set-Changeset.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Set-Changeset.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Set-Changeset.ps1' -Tag 'Offline', 'TFVC' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_changesets_200.json') -Raw | ConvertFrom-Json
        }
