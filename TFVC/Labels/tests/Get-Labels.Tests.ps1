...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Labels.ps1
...
Describe 'Get-Labels.ps1' -Tag 'Offline', 'TFVC' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_labels_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/tfvc/labels?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
