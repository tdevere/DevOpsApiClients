...
<#
.SYNOPSIS
    Pester offline unit tests for Remove-Testsuiterecyclebinoperation.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Remove-Testsuiterecyclebinoperation.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Remove-Testsuiterecyclebinoperation.ps1' -Tag 'Offline', 'TestPlan' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_deleted_test_suites_for_project_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/testplan/recycleBin/testsuite?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
