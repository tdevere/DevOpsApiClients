...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Availability.ps1
...
Describe 'Get-Availability.ps1' -Tag 'Offline', 'Symbol' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'get_check_availability_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://artifacts.dev.azure.com/testorg/_apis/symbol/availability?api-version=7.2" -and
                $Method -eq 'Get'
            }
        }
