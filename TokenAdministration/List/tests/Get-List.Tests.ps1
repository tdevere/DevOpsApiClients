...
Describe 'Get-List.ps1' -Tag 'Offline', 'TokenAdministration' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/_apis/tokenadministration/tokenlistglobalidentities?api-version=5.2" -and
                $Method -eq 'Post'
            }
        }
