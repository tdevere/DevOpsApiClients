...
.DESCRIPTION
    Calls  POST {org}/{team}/_apis/dashboard/dashboards/{dashboard_id}/widgets?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/dashboard/widgets/create?view=azure-devops-rest-7.2
#>
...
param (
    ...
    [Parameter(Mandatory)]
    [string]$AreSettingsBlockedForUser,

    [Parameter(Mandatory)]
    [string]$ArtifactId,

    [Parameter(Mandatory)]
    [string]$ConfigurationContributionId,
