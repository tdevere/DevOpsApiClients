...
.DESCRIPTION
    Calls  PATCH {org}/_apis/release/releases/{release_id}?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/release/releases/update-release-resource?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/release/releases/$ReleaseId" -ApiVersion $ApiVersion -Project $ProjectId -BaseHost "vsrm.dev.azure.com"
