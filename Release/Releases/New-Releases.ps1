...
.DESCRIPTION
    Calls  POST {org}/_apis/release/releases?api-version=7.2
    Uses Basic Auth with a PAT stored in $env:AZURE_DEVOPS_PAT.

.LINK
    https://learn.microsoft.com/en-us/rest/api/azure/devops/release/releases/create?view=azure-devops-rest-7.2
#>
...
#--- Call the API -----------------------------------------------------------
$uri = New-AdoUrl -Organization $Organization -Path "_apis/release/releases" -ApiVersion $ApiVersion -Project $ProjectId -BaseHost "vsrm.dev.azure.com"
