...
<#
.SYNOPSIS
    Pester offline unit tests for Get-Definitions.ps1
...
BeforeAll {
    $ScriptPath = Join-Path $PSScriptRoot '..' 'Get-Definitions.ps1'
    $FixturePath = Join-Path $PSScriptRoot 'fixtures'
    $ProjectGuid = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
}

Describe 'Get-Definitions.ps1' -Tag 'Offline', 'Release' {
