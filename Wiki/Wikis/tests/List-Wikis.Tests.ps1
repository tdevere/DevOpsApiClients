...
<#
.SYNOPSIS
    Pester offline unit tests for List-Wikis.ps1
...
Describe 'List-Wikis.ps1' -Tag 'Offline', 'Wiki' {
    ...
    Context 'Successful API call (mocked)' {
        ...
        BeforeAll {
            $fixture = Get-Content (Join-Path $FixturePath 'list_wikis_200.json') -Raw | ConvertFrom-Json
        }
        ...
        It 'Calls the correct URL' {
            ...
            Should -Invoke Invoke-RestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -eq "https://dev.azure.com/testorg/$ProjectGuid/_apis/wiki/wikis?api-version=7.2-preview.2" -and
                $Method -eq 'Get'
            }
        }
